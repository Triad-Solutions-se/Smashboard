...
export const GROUP_PALETTE = [
  {
    ...
    solidBar:
      "bg-emerald-100/70 text-emerald-900 dark:bg-emerald-950/40 dark:text-emerald-100",
  ...
  },
  {
    ...
    solidBar:
      "bg-sky-100/70 text-sky-900 dark:bg-sky-950/40 dark:text-sky-100",
    border: "border-sky-200 dark:border-sky-900/60",
    spine: "border-l-sky-500 dark:border-l-sky-500",
    numberBadge: "bg-sky-600 text-white dark:bg-sky-500 dark:text-white",
  },
  {
    badge:
    ...
    solidBar:
      "bg-amber-100/70 text-amber-900 dark:bg-amber-950/40 dark:text-amber-100",
    border: "border-amber-200 dark:border-amber-900/60",
    spine: "border-l-amber-500 dark:border-l-amber-500",
    numberBadge: "bg-amber-500 text-white dark:bg-amber-500 dark:text-white",
  },
  {
    badge:
    ...
    solidBar:
      "bg-violet-100/70 text-violet-900 dark:bg-violet-950/40 dark:text-violet-100",
